...
//     mostrarTabla(data,'js-table-datos')//llamado a la funcion mostrarTabla que muestra los atributos del array en el documento
//     let datosGrafico = data.filter((element) => element.confirmed > 2000000); //Metodo filter, para mostrar los casos confirmados e imprimirlos en el grafico
//     console.log(datosGrafico);
//     generarBarras(datosGrafico)
...
//     <td>${recuperados}</td>
//     <td>${activos}</td>
//     <td><a href="" data-toggle="modal" data-target="#exampleModal" onclick="generarTorta('${pais}','${confirmados}','${muertos}','${recuperados}','${activos}')"> ver detalle </a></td>
//     </tr>`;
//     console.log("elemento del foreach", element)
//   });
//   $(`#js-tabla-datos tbody`).append(rows);
// }

// // $('button').on('click',() => {
// //     let link = document.getElementById('js-ingresar')
// //     link.innerHTML = "hola mundo"
// //     })
